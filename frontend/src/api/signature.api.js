...
export const getPublicSignature = async (token, email) => {
...
export const getAllPublicSignatures = async (documentId) => {
    return api.get(`/api/signatures/public/all/${documentId}`)
}
